...
function App() {
  ...
  return (
    <>
    <header className='bg-blue-500 -mt-8 rounded-full'>
      <h1 className='text-black'>Birthday Presents</h1>
    </header>
    ...
    <div className='mt-3 gifts flex flex-col flex-wrap gap-y-5 mr-auto'>
      <p className=''>10 different items from the carrefour bakery</p>
     ...
     <div className='relative w-56 rounded-xl '>
      ...
      <div className='bg-contain rounded-xl bg-no-repeat p-8 bg-center  bg-[url("sake.png")]'><p className='text-3xl text-slate-400 font-semibold '>Japanese sake 😭</p></div>
